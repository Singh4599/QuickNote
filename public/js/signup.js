(function () {
    ...
    function activate(role) {
      ...
      if (role === "patient") {
        brand.className = "relative p-10 md:p-12 bg-gradient-to-br from-blue-50 via-white to-blue-100";
        ...
        roleExtra.innerHTML = `<span class="inline-flex items-center gap-2 px-3 py-2 rounded-full bg-blue-50 text-blue-600 font-semibold">
          ⚡ 24×7 Emergency Support</span>`;
      } else if (role === "doctor") {
        brand.className = "relative p-10 md:p-12 bg-gradient-to-br from-green-50 via-white to-green-100";
        ...
        brand.className = "relative p-10 md:p-12 bg-gradient-to-br from-purple-50 via-white to-purple-100";
        ...
        roleExtra.className = "mt-4 text-center";
        roleExtra.innerHTML = `<span class="inline-flex items-center gap-2 px-3 py-2 rounded-full bg-purple-50 text-purple-700 font-semibold">
