# MediSync - Hospital Availability & Patient Information System

## Project Overview
- **Name**: MediSync
- **Goal**: Real-time hospital availability tracking and patient appointment management system for seamless healthcare access
