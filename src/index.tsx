...
<head>
    ...
    <title>MediSync - Hospital Availability System</title>
...
<body>
    <div id="app">
        <div class="auth-container">
            <div class="auth-card">
                <h1><i class="fas fa-hospital-symbol"></i> MediSync</h1>
...
<body>
    <div id="app">
        <nav class="navbar">
            <div class="nav-brand">
                <i class="fas fa-hospital-symbol"></i> MediSync
            </div>
            <div class="nav-menu">
